...
|**HU6**|Base vectorial|Como sistema, quiero guardar los segmentos y embeddings en una base de datos para consultarlos durante la conversación.|
...
|**HU12**|Selección de voz y transcripción|Como estudiante, quiero visualizar la transcripción de la sesión mientras converso.|
...
|**HU14**|Registro de latencias y recuperaciones|Como investigador, quiero registrar la latencia del sistema y la respuesta del estudiante.|
|**HU15**|Cálculo de ICA y métricas|Como investigador, quiero calcular ICA, PR, LP y RAGAs con los datos de las sesiones.|
|**HU16**|Panel y exportación de resultados|Como investigador, quiero consultar metricas y exportar los resultados en CSV para utilizarlos en el informe de investigación.|
|**HU17**|Manejo de errores y limitaciones|Como usuario, quiero recibir mensajes claros cuando falte conexión, micrófono, parlantes, configuración o contexto relevante.|
...
|**HU15**|Cálculo de ICA y métricas|1|
|**HU16**|Panel y exportación de resultados|1|
|**HU17**|Manejo de errores y limitaciones|2|
...
|**Sprint 8** 06–19 julio (Evaluación)|HU15|Cálculo de ICA y métricas|XL|8|3|
|**Subtotal Sprint 8**||||**13**|**5**|
|**Sprint 9** 20 julio–02 agosto (Reporte y documentación)|HU16|Panel y exportación de resultados|L|5|2|
|**Subtotal Sprint 9**||||5|2|
|**Sprint 10** 03–16 agosto (Calidad y errores)|HU17|Manejo de errores y limitaciones|M|3|1\.5|
