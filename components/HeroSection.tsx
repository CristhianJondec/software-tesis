            ...
            <div className="library-hero-card">
                <div className="library-hero-content">
                    ...
                    <div className="library-hero-text">
                        <h1 className="library-hero-title text-4xl font-serif font-bold">Tus Investigaciones</h1>
                        <p className="library-hero-description">
                            Convierte tus investigaciones en conversaciones interactivas con IA. <br className="hidden md:block" />
                        ...
                        <Link href="/books/new" className="library-cta-primary mt-4 flex items-center justify-center">
                            ...
                            <span className="text-[#212a3b]">Agregar investigación</span>
                        </Link>
                    </div>
                    ...
                    <div className="library-hero-illustration-desktop">
                        <Image
                            ...
                            alt="Investigaciones universitarias y documentos de investigación"
                            width={400}
                            height={400}
                        ...
                        <ul className="space-y-6">
                            <li className="library-step-item">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <p className="library-step-description text-gray-500">Agrega tu archivo de investigación</p>
                                </div>
                            </li>
                            <li className="library-step-item">
